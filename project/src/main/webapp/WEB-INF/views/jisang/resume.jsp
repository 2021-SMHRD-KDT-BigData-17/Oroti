		...
		<form action="#" method="get">
			...
			<table class="resume_content" border="1" cellspacing="0">
				<tr>
					...
					<td class="person_number_input"><input type="password"
				...
				<tr> 
					...
					<input class="small_address" type="text" placeholder="&nbsp;(상세주소)"></td>
				</tr>
				<tr>
					<td class="phone_number">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;휴대전화</td>
					<td class="phone_number_input" colspan="3"><input
						class="phonenumberbox" type="text"></td>
				</tr>
				<tr>
