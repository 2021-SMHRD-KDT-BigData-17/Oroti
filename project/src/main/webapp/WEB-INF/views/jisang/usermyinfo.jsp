            ...
            <form action="#" method="get">
                <table class="edit_area">
                    ...
                    <tr class="user_address">
                        ...
                        <td class="edit_content">&nbsp;&nbsp;&nbsp;전남 OO시 oo동 oo아파트</td>
                    </tr>
                    <tr class="user_phone">
                        <td class="edit_list">연락처</td>
                        <td class="edit_content">&nbsp;&nbsp;&nbsp;123-4567-8910</td>
                    </tr>
                    <tr class="user_email">
                        <td class="edit_list">이메일</td>
                        <td class="edit_content">&nbsp;&nbsp;&nbsp;poyong@poyong.net</td>
                    </tr>
                    <tr class="disability_type">
                        <td class="edit_list">장애유형</td>
                        <td class="edit_content">&nbsp;&nbsp;&nbsp;청각장애</td>
                    </tr>
                ...
                <a href="#"><button class="edit_btn" type="submit">수정</button></a>
            </form>
        </div>
        <div class="side">
