    ...
    <div class="container">
      ...
      <div class="result">
        ...
        <p> IT 정보통신업은 정보 기술과 통신 기술을 결합하여 제공되는 다양한 서비스와 솔루션을 제공하는 산업입니다.</p> 
       	<p> 이 산업은 컴퓨터와 네트워크 등의 기술을 활용하여 데이터의 전송과 통신을 가능하게 하며, 정보의 저장, 처리, 전달을 위한 다양한 시스템과 서비스를 개발, 운영, 유지보수합니다.</p>
        <p>추천 직업:</p>
      ...
      <div class="result">
        <h3>사무직:</h3>
        <p>사무직은 사무 업무를 수행하는 직종을 일컫는 용어로, 조직 내에서 정보 처리, 문서 작성, 기록 보관, 일정 관리, 회의 조정 등의 업무를 담당합니다.</p> 
      	<p>사무직은 다양한 조직이나 기업의 업무를 원활하게 진행하기 위해 필요한 역할을 수행하며, 기업의 효율성과 생산성에 직결됩니다.</p>
      	<p>추천직업:</p>
      	<span>비서, 경리, 회계사</span>
      </div>
      <div class="result">
        <h3>서비스업:</h3>
        <p>서비스업은 상품의 생산과는 달리 물리적인 제품을 생산하지 않고, 고객에게 다양한 종류의 서비스를 제공하는 경제 활동을 의미합니다.</p> 
