...
<body>
    <div class="SignIn_wrap">
        ...
        <div class="container">
            ...
            <!-- 로그인 폼 (시작) -->
            <form action="/SignIn" method="post"><!-- action : spring 파일 경로, method : get / post (백엔드 부분) -->

                <!-- 회원 유형 선택 (시작) -->
                <div class="user_mode">
                    <label>
                        <input type="radio" name="user" value="indiv" checked required>개인회원
                    </label>
                    <label>
                        <input type="radio" name="user" value="corp" required>기업회원
                    </label>
                </div>
                <!-- 회원 유형 선택 (끝) -->
