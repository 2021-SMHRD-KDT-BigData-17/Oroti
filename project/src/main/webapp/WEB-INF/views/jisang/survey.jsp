                ...
                <form method="post" action="${path}/surveyinsert.do">
                    <div class="question_wrapper_0">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_0_2' id="yes" value="2">
                            <input type="radio" name='ans_0_2' id="soso" value="3">
                            <input type="radio" name='ans_0_2' id="no" value="4">
                            <input type="radio" name='ans_0_2' id="very_no" value="5">
                            <h3>60 ~ 69</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_0_3' id="soso" value="2">
                            <input type="radio" name='ans_0_3' id="very_no" value="3">
                            <h3>대졸이상</h3>
                        </div>
                        <div class="questions">
                            <h2>장애정도를 입력해주세요.</h2>
                    ...
                    <div class="question_wrapper">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_1' id="yes" value="2">
                            <input type="radio" name='ans_1' id="soso" value="3">
                            <input type="radio" name='ans_1' id="no" value="4">
                            <input type="radio" name='ans_1' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_2' id="yes" value="2">
                            <input type="radio" name='ans_2' id="soso" value="3">
                            <input type="radio" name='ans_2' id="no" value="4">
                            <input type="radio" name='ans_2' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_3' id="yes" value="2">
                            <input type="radio" name='ans_3' id="soso" value="3">
                            <input type="radio" name='ans_3' id="no" value="4">
                            <input type="radio" name='ans_3' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_4' id="yes" value="2">
                            <input type="radio" name='ans_4' id="soso" value="3">
                            <input type="radio" name='ans_4' id="no" value="4">
                            <input type="radio" name='ans_4' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_5' id="yes" value="2">
                            <input type="radio" name='ans_5' id="soso" value="3">
                            <input type="radio" name='ans_5' id="no" value="4">
                            <input type="radio" name='ans_5' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_6' id="yes" value="2">
                            <input type="radio" name='ans_6' id="soso" value="3">
                            <input type="radio" name='ans_6' id="no" value="4">
                            <input type="radio" name='ans_6' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <!-- 페이지 이동 버튼 -->
                    ...
                    <div class="question_wrapper_2">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_7' id="yes" value="2">
                            <input type="radio" name='ans_7' id="soso" value="3">
                            <input type="radio" name='ans_7' id="no" value="4">
                            <input type="radio" name='ans_7' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_8' id="yes" value="2">
                            <input type="radio" name='ans_8' id="soso" value="3">
                            <input type="radio" name='ans_8' id="no" value="4">
                            <input type="radio" name='ans_8' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_9' id="yes" value="2">
                            <input type="radio" name='ans_9' id="soso" value="3">
                            <input type="radio" name='ans_9' id="no" value="4">
                            <input type="radio" name='ans_9' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_10' id="yes" value="2">
                            <input type="radio" name='ans_10' id="soso" value="3">
                            <input type="radio" name='ans_10' id="no" value="4">
                            <input type="radio" name='ans_10' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_11' id="yes" value="2">
                            <input type="radio" name='ans_11' id="soso" value="3">
                            <input type="radio" name='ans_11' id="no" value="4">
                            <input type="radio" name='ans_11' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_12' id="yes" value="2">
                            <input type="radio" name='ans_12' id="soso" value="3">
                            <input type="radio" name='ans_12' id="no" value="4">
                            <input type="radio" name='ans_12' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <div class="questions">
                        ...
                        <div class="answer">
                            ...
                            <input type="radio" name='ans_13' id="yes" value="2">
                            <input type="radio" name='ans_13' id="soso" value="3">
                            <input type="radio" name='ans_13' id="no" value="4">
                            <input type="radio" name='ans_13' id="very_no" value="5">
                            <h3>아니오</h3>
                        </div>
                        <!-- 페이지 이동 버튼 -->
                        <div class="move_button">
